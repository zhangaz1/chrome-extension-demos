...
Actions = (function() {
    ...
    (function() {
        ...
        _.closeTabLeft = function(o) {
            closeTab(o, -o.request.repeats);
        };
        _.closeTabRight = function(o) {
            closeTab(o, o.request.repeats);
        };
        _.closeTabsToLeft = function(o) {
    ...
    _.openLastLinkInTab = function(o) {
        ...
        if (hist.links[hist.state - o.request.repeats] !== void 0) {
            openTab({
                url: hist.links[hist.state - o.request.repeats]
            });
        }
    };
    ...
    _.lastActiveTab = function(o) {
        if (ActiveTabs[o.sender.tab.windowId] !== void 0) {
            chrome.tabs.update(ActiveTabs[o.sender.tab.windowId].shift(), {
                active: true
            });
        }
    };
            ...
            chrome.tabs.query({}, function(tabs) {
                for (var i = 0; i < tabs.length; i++) {
                    if (LastUsedTabs[0] === tabs[i].id) {
                        chrome.tabs.update(LastUsedTabs[0], {
                            active: true
                        });
                        break;
                    }
    ...
    _.injectCSS = function(o) {
        chrome.tabs.insertCSS(o.sender.tab.id, {
            code: o.request.css
        }, function() {
    ...
    _.parseRC = function(o) {
        o.callback({
            type: 'parseRC',
            config: RCParser.parse(o.request.config)
        });
    };
    ...
    _.muteTab = function(o) {
        chrome.tabs.update(o.sender.tab.id, {
            muted: !o.sender.tab.mutedInfo.muted
        });
    };
